...
-- disable x server screen saver, remove this in the future if switch to wyland
...
globalkeys = gears.table.join(
	...
	end, { description = "switch between apps inside one monitor", group = "client" }),
	-- Switch focus to next monitor with Super+``
	...
	end, { description = "launch flameshot gui", group = "apps" }),
